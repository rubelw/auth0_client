import unittest
import mock
from auth0_client.v3.authentication.authorize_client import AuthorizeClient


class TestAuthorizeClient(unittest.TestCase):

    @mock.patch('auth0_client.v3.authentication.authorize_client.AuthorizeClient.get')
