import unittest
import mock
from auth0_client.v3.authentication.users import Users


class TestUsers(unittest.TestCase):

    @mock.patch('auth0_client.v3.authentication.users.Users.get')
    ...
    @mock.patch('auth0_client.v3.authentication.users.Users.post')
